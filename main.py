...
#         speak("helllo How can i help you!")
...
#                 message = takeCommand()
#                 # Note: Sending WhatsApp message programmatically requires additional setup, like Twilio or selenium. For now, opening WhatsApp.
#                 webbrowser.open(f"https://web.whatsapp.com/send?phone={contact}&text={message}")
#                 speak("Opening WhatsApp with the message.")
#             except Exception as e:
